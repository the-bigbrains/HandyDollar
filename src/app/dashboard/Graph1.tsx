  ...
  return (
    <>
      ...
      <LineChart
        ...
        <XAxis dataKey="date" label={{ value: 'Transaction dates', angle: 0, position: 'bottom', offset: 0   }} />
        <YAxis dataKey="amount" label={{value:'Amount ($)', angle: -90, position:'left'}} reversed />
        <Tooltip />
        <Line type="monotone" dataKey="name" stroke="#8884d8" strokeWidth={2} />
        <Line type="monotone" dataKey="amount" stroke="#8884d8" strokeWidth={2} />  
        <Line type="monotone" dataKey="date" stroke="#8884d8" strokeWidth={2} />
